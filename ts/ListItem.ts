...
module ap {
    ...
    var $q, toastr, apCacheService, apDataService, apEncodeService, apUtilityService,
    ...
    export class ListItem implements ap.IListItem {
         ...
         */
        getAvailableWorkflows(): ng.IPromise<ap.IWorkflowDefinition[]> {
            var listItem = this;
    ...
    angular
        .module('angularPoint')
        .service('ListItemFactory', ListItemFactory);
}
